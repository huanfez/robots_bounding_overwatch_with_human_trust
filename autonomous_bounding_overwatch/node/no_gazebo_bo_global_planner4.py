...
import parameter4_mcmc as pmc4
import parameters_env_img_robot as common_parameters
import simulated_human4 as simh4
...
if __name__ == '__main__':
    try:
        ...
        ax[0, 0].plot(x, norm.pdf(x, Beta0_itr[0], np.sqrt(Sigma0_itr[0, 0])), 'r-', lw=1, alpha=0.9, label=r'$\beta_{-1}$')
        ax[0, 0].plot(x, norm.pdf(x, Beta0_itr[1], np.sqrt(Sigma0_itr[1, 1])), 'g-', lw=1, alpha=0.9, label=r'$\beta_0$')
        ax[0, 0].plot(x, norm.pdf(x, Beta0_itr[2], np.sqrt(Sigma0_itr[2, 2])), 'b-', lw=1, alpha=0.9, label=r'$\beta_1$')
        ax[0, 0].plot(x, norm.pdf(x, Beta0_itr[3], np.sqrt(Sigma0_itr[3, 3])), 'y-', lw=1, alpha=0.9, label=r'$\beta_2$')
        ...
        # ax[0, 0].set_ylim([1.2615e-3, 1.26165e-3])
        ...
        ax[0, 0].axvline(x=common_parameters.beta_true3[3], color='c', linestyle='-.', lw=1.5)
        ...
        for iteration in range(0, 31):
            ...
            y_1toK = simh4.simulated_human_data(common_parameters.beta_true3, common_parameters.delta_w_true3,
            ...
            samples_x_1toK, samples_Beta, samples_delta_w_square, samples_delta_v_square, Beta0_itr, Sigma0_itr, a0_itr, b0_itr, \
                c0_itr, d0_itr = pmc4.iterated_sampling(y_1toK, Z_1toK, Beta0_itr, Sigma0_itr, a0_itr, b0_itr, c0_itr, d0_itr, Alpha, iters=7000)
            ...
            means_Beta, variance_Beta, means_delta_w_square, variance_delta_w_square, means_delta_v_square, \
                variance_delta_v_square = pmc4.mean_value_model_parameters(samples_x_1toK, samples_Beta,
                                                                           samples_delta_w_square,
                                                                           samples_delta_v_square)
            # pmc4.mean_value_model_parameters_(Beta0_itr, Sigma0_itr, a0_itr, b0_itr, c0_itr, d0_itr)
            ...
            if iteration < 15 and iteration % 5 == 0:
                ...
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, Beta0_itr[0], np.sqrt(Sigma0_itr[0,0])), 'r-', lw=1, alpha=0.9,
                              label=r'$\beta_{-1}$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, Beta0_itr[1], np.sqrt(Sigma0_itr[1,1])), 'g-', lw=1, alpha=0.9,
                              label=r'$\beta_0$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, Beta0_itr[2], np.sqrt(Sigma0_itr[2,2])), 'b-', lw=1, alpha=0.9,
                              label=r'$\beta_1$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, Beta0_itr[3], np.sqrt(Sigma0_itr[3,3])), 'y-', lw=1,
                                      alpha=0.9, label=r'$\beta_2$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, Beta0_itr[4], np.sqrt(Sigma0_itr[4,4])), 'c-', lw=1, alpha=0.9,
                              label=r'$b$')
            ...
            if iteration >= 15 and iteration % 5 == 0:
                ax[(iteration-15)/5, 1].plot(x, norm.pdf(x, Beta0_itr[0], np.sqrt(Sigma0_itr[0,0])), 'r-', lw=1, alpha=0.9,
                              label=r'$\beta_{-1}$')
                ax[(iteration-15)/5, 1].plot(x, norm.pdf(x, Beta0_itr[1], np.sqrt(Sigma0_itr[1,1])), 'g-', lw=1, alpha=0.9,
                              label=r'$\beta_0$')
                ax[(iteration-15)/5, 1].plot(x, norm.pdf(x, Beta0_itr[2], np.sqrt(Sigma0_itr[2,2])), 'b-', lw=1, alpha=0.9,
                              label=r'$\beta_1$')
                ax[(iteration-15)/5, 1].plot(x, norm.pdf(x, Beta0_itr[3], np.sqrt(Sigma0_itr[3,3])), 'y-', lw=1, alpha=0.9,
                              label=r'$\beta_2$')
                ax[(iteration-15)/5, 1].plot(x, norm.pdf(x, Beta0_itr[4], np.sqrt(Sigma0_itr[4, 4])), 'c-', lw=1,
                                           alpha=0.9, label=r'$b$')
                ax[(iteration-15)/5, 1].legend(loc='upper right', frameon=False)

                ax[(iteration-15)/5, 1].axvline(x=common_parameters.beta_true3[0], color='r', linestyle='-.', lw=1.5)
                ax[(iteration-15)/5, 1].axvline(x=common_parameters.beta_true3[1], color='g', linestyle='-.', lw=1.5)
                ax[(iteration-15)/5, 1].axvline(x=common_parameters.beta_true3[2], color='b', linestyle='-.', lw=1.5)
                ax[(iteration-15)/5, 1].axvline(x=common_parameters.beta_true3[3], color='y', linestyle='-.', lw=1.5)
                ax[(iteration-15)/5, 1].axvline(x=common_parameters.beta_true3[4], color='c', linestyle='-.', lw=1.5)

            y_1toK_pred = simh4.simulated_human_data(Beta0_itr, means_delta_w_square, means_delta_v_square, Z_1toK)
