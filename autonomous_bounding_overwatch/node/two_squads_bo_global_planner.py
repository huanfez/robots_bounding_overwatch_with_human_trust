...
if __name__ == '__main__':
    try:
        ...
        for iteration in range(0, 20):
            ...
            optimo_cell_path, f = cps.optimal_cell_path_pi(Beta0_itr, Sigma0_itr, common_parameters.candidate_cell_path_list,
            ...
            if iteration < 4:
                ax[iteration, 0].plot(x, norm.pdf(x, means_Beta[0], np.sqrt(variance_Beta[0,0])), 'r-', lw=1, alpha=0.9,
                              label=r'$\beta_0$')
                ax[iteration, 0].plot(x, norm.pdf(x, means_Beta[1], np.sqrt(variance_Beta[1,1])), 'g-', lw=1, alpha=0.9,
                              label=r'$\beta_1$')
                ax[iteration, 0].plot(x, norm.pdf(x, means_Beta[2], np.sqrt(variance_Beta[2,2])), 'b-', lw=1, alpha=0.9,
                              label=r'$\beta_2$')
                ax[iteration, 0].plot(x, norm.pdf(x, means_Beta[3], np.sqrt(variance_Beta[3,3])), 'y-', lw=1, alpha=0.9,
                              label=r'$b$')
                ax[iteration, 0].legend(loc='upper right', frameon=False)

                ax[iteration, 0].axvline(x=common_parameters.beta_true[0], color='r', linestyle='-.', lw=0.5)
                ax[iteration, 0].axvline(x=common_parameters.beta_true[1], color='g', linestyle='-.', lw=0.5)
                ax[iteration, 0].axvline(x=common_parameters.beta_true[2], color='b', linestyle='-.', lw=0.5)
                ax[iteration, 0].axvline(x=common_parameters.beta_true[3], color='y', linestyle='-.', lw=0.5)
            ...
            if iteration > 15:
                ...
                ax[iteration-16, 1].axvline(x=common_parameters.beta_true[0], color='r', linestyle='-.', lw=0.5)
                ax[iteration-16, 1].axvline(x=common_parameters.beta_true[1], color='g', linestyle='-.', lw=0.5)
                ax[iteration-16, 1].axvline(x=common_parameters.beta_true[2], color='b', linestyle='-.', lw=0.5)
                ax[iteration-16, 1].axvline(x=common_parameters.beta_true[3], color='y', linestyle='-.', lw=0.5)
