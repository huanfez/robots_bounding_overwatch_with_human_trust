...
if __name__ == '__main__':
    try:
        ...
        Beta0_itr = np.asarray([0.65, 0.5, 0.5, -0.1])
        ...
        ax[0, 0].axvline(x=common_parameters.beta_true[0], color='r', linestyle='-.', lw=1.5)
        ax[0, 0].axvline(x=common_parameters.beta_true[1], color='g', linestyle='-.', lw=1.5)
        ax[0, 0].axvline(x=common_parameters.beta_true[2], color='b', linestyle='-.', lw=1.5)
        ax[0, 0].axvline(x=common_parameters.beta_true[3], color='y', linestyle='-.', lw=1.5)
        ...
        for iteration in range(0, 21):
            ...
            optimo_cell_path, f = cps.optimal_cell_path_pi2(Beta0_itr, Sigma0_itr, common_parameters.candidate_cell_path_list,
            ...
            y_1toK = simh.simulated_human_data(common_parameters.beta_true, common_parameters.delta_w_true,
                                               common_parameters.delta_v_true, Z_1toK)
            # Z_1toK_data = cps2.cell_path_situational_awareness(optimo_cell_path, environment_dict)
            # y_1toK = simh3.simulated_human_data(common_parameters.beta_true3, common_parameters.delta_w_true3,
            #                                     common_parameters.delta_v_true3, Z_1toK_data)
            ...
            if iteration < 10 and iteration % 5 == 0:
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, means_Beta[0], np.sqrt(variance_Beta[0,0])), 'r-', lw=1, alpha=0.9,
                              label=r'$\beta_0$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, means_Beta[1], np.sqrt(variance_Beta[1,1])), 'g-', lw=1, alpha=0.9,
                              label=r'$\beta_1$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, means_Beta[2], np.sqrt(variance_Beta[2,2])), 'b-', lw=1, alpha=0.9,
                              label=r'$\beta_2$')
                ax[iteration/5 + 1, 0].plot(x, norm.pdf(x, means_Beta[3], np.sqrt(variance_Beta[3,3])), 'y-', lw=1, alpha=0.9,
                              label=r'$b$')
                ...
                ax[iteration/5 + 1, 0].axvline(x=common_parameters.beta_true[0], color='r', linestyle='-.', lw=1.5)
                ax[iteration/5 + 1, 0].axvline(x=common_parameters.beta_true[1], color='g', linestyle='-.', lw=1.5)
                ax[iteration/5 + 1, 0].axvline(x=common_parameters.beta_true[2], color='b', linestyle='-.', lw=1.5)
                ax[iteration/5 + 1, 0].axvline(x=common_parameters.beta_true[3], color='y', linestyle='-.', lw=1.5)

            if iteration >= 10 and iteration % 5 == 0:
                ax[(iteration-10)/5, 1].plot(x, norm.pdf(x, means_Beta[0], np.sqrt(variance_Beta[0,0])), 'r-', lw=1, alpha=0.9,
                              label=r'$\beta_0$')
                ax[(iteration-10)/5, 1].plot(x, norm.pdf(x, means_Beta[1], np.sqrt(variance_Beta[1,1])), 'g-', lw=1, alpha=0.9,
                              label=r'$\beta_1$')
                ax[(iteration-10)/5, 1].plot(x, norm.pdf(x, means_Beta[2], np.sqrt(variance_Beta[2,2])), 'b-', lw=1, alpha=0.9,
                              label=r'$\beta_2$')
                ax[(iteration-10)/5, 1].plot(x, norm.pdf(x, means_Beta[3], np.sqrt(variance_Beta[3,3])), 'y-', lw=1, alpha=0.9,
                              label=r'$b$')
                ...
                ax[(iteration-10)/5, 1].axvline(x=common_parameters.beta_true[0], color='r', linestyle='-.', lw=1.5)
                ax[(iteration-10)/5, 1].axvline(x=common_parameters.beta_true[1], color='g', linestyle='-.', lw=1.5)
                ax[(iteration-10)/5, 1].axvline(x=common_parameters.beta_true[2], color='b', linestyle='-.', lw=1.5)
                ax[(iteration-10)/5, 1].axvline(x=common_parameters.beta_true[3], color='y', linestyle='-.', lw=1.5)
