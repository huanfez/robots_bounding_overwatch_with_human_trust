...
def sample_xall(y_1toK, Z_1toK, xall_1toK_s, Beta_s, xi_square_s, Alpha, xi2_square_s,
    ...
    Delta_s = np.array([[xi_square_s, xi_square_s * Beta_s[0], 0],
                        [xi_square_s * Beta_s[0], xi_square_s * (Beta_s[0]**2 + 1), xi_square_s * Beta_s[0]],
                        [0, xi_square_s * Beta_s[0], xi_square_s * (Beta_s[0]**2 + 1)]])
    Q[0:3, 0:3] = Delta_s
